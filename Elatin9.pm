...
#               $pattern .= "(?:$your_char)",   # UNIX style
        ...
        my $matchsub = sub { Elatin9::fc($_[0]) =~ m{\A $pattern \z}xms };
...
=item Chop string
  ...
  character chopped. The Elatin9::chop function is used primary to remove the newline
...
=item Reverse index string
  ...
  This function works just like Elatin9::index except that it returns the byte
...
=item Lower case string
  ...
  You can use the Elatin9::fc function for case-insensitive comparisons via Latin9
  software.
...
=item Fold case string
  ...
  New to Latin9 software, this function returns the full Unicode-like casefold of
...
=item Filename expansion (globbing)
  ...
  The Elatin9::glob function grandfathers the use of whitespace to separate multiple
