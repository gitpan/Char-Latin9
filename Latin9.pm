...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Latin9 software provides)

Latin9 software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Latin9 software provide)
