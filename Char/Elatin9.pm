...
#
package Char::Elatin9;
######################################################################
#
# Char::Elatin9 - Run-time routines for Char/Latin9.pm
#
...
BEGIN {
    ...
    sub qualify ($;$) {
        my ($name) = @_;
        if (!ref($name) && (Char::Elatin9::index($name, '::') == -1) && (Char::Elatin9::index($name, "'") == -1)) {
            my $pkg;
...
sub import {
    ...
    if ($^O =~ /\A (?: MSWin32 | NetWare | symbian | dos ) \z/oxms) {
        ...
        for (@ARGV) {
            ...
            # has space
            if (/\A (?:$q_char)*? [ ] /oxms) {
                if (my @glob = Char::Elatin9::glob(qq{"$_"})) {
                    push @argv, @glob;
                }
                else {
                    push @argv, $_;
            ...
            # has wildcard metachar
                ...
                if (my @glob = Char::Elatin9::glob($_)) {
                    push @argv, @glob;
                }
                else {
                    push @argv, $_;
...
#
sub unimport {}
sub Char::Elatin9::split(;$$$);
sub Char::Elatin9::tr($$$$;$);
sub Char::Elatin9::chop(@);
sub Char::Elatin9::index($$;$);
sub Char::Elatin9::rindex($$;$);
sub Char::Elatin9::lcfirst(@);
sub Char::Elatin9::lcfirst_();
sub Char::Elatin9::lc(@);
sub Char::Elatin9::lc_();
sub Char::Elatin9::ucfirst(@);
sub Char::Elatin9::ucfirst_();
sub Char::Elatin9::uc(@);
sub Char::Elatin9::uc_();
sub Char::Elatin9::fc(@);
sub Char::Elatin9::fc_();
sub Char::Elatin9::ignorecase;
sub Char::Elatin9::classic_character_class;
sub Char::Elatin9::capture;
sub Char::Elatin9::chr(;$);
sub Char::Elatin9::chr_();
sub Char::Elatin9::glob($);
sub Char::Elatin9::glob_();

sub Char::Latin9::ord(;$);
sub Char::Latin9::ord_();
sub Char::Latin9::reverse(@);
sub Char::Latin9::getc(;*@);
sub Char::Latin9::length(;$);
sub Char::Latin9::substr($$;$$);
sub Char::Latin9::index($$;$);
sub Char::Latin9::rindex($$;$);
sub Char::Latin9::escape(;$);
...
${Char::Elatin9::dot}         = qr{(?:[^\x0A])};
${Char::Elatin9::dot_s}       = qr{(?:[\x00-\xFF])};
${Char::Elatin9::eD}          = qr{(?:[^0-9])};
...
# ${Char::Elatin9::eS}        = qr{(?:[^\x09\x0A    \x0C\x0D\x20])};
# ${Char::Elatin9::eS}        = qr{(?:[^\x09\x0A\x0B\x0C\x0D\x20])};
${Char::Elatin9::eS}          = qr{(?:[^\s])};

${Char::Elatin9::eW}          = qr{(?:[^0-9A-Z_a-z])};
${Char::Elatin9::eH}          = qr{(?:[^\x09\x20])};
${Char::Elatin9::eV}          = qr{(?:[^\x0A\x0B\x0C\x0D])};
${Char::Elatin9::eR}          = qr{(?:\x0D\x0A|[\x0A\x0D])};
${Char::Elatin9::eN}          = qr{(?:[^\x0A])};
${Char::Elatin9::not_alnum}   = qr{(?:[^\x30-\x39\x41-\x5A\x61-\x7A])};
${Char::Elatin9::not_alpha}   = qr{(?:[^\x41-\x5A\x61-\x7A])};
${Char::Elatin9::not_ascii}   = qr{(?:[^\x00-\x7F])};
${Char::Elatin9::not_blank}   = qr{(?:[^\x09\x20])};
${Char::Elatin9::not_cntrl}   = qr{(?:[^\x00-\x1F\x7F])};
${Char::Elatin9::not_digit}   = qr{(?:[^\x30-\x39])};
${Char::Elatin9::not_graph}   = qr{(?:[^\x21-\x7F])};
${Char::Elatin9::not_lower}   = qr{(?:[^\x61-\x7A])};
${Char::Elatin9::not_lower_i} = qr{(?:[\x00-\xFF])};
${Char::Elatin9::not_print}   = qr{(?:[^\x20-\x7F])};
${Char::Elatin9::not_punct}   = qr{(?:[^\x21-\x2F\x3A-\x3F\x40\x5B-\x5F\x60\x7B-\x7E])};
${Char::Elatin9::not_space}   = qr{(?:[^\s\x0B])};
${Char::Elatin9::not_upper}   = qr{(?:[^\x41-\x5A])};
${Char::Elatin9::not_upper_i} = qr{(?:[\x00-\xFF])};
${Char::Elatin9::not_word}    = qr{(?:[^\x30-\x39\x41-\x5A\x5F\x61-\x7A])};
${Char::Elatin9::not_xdigit}  = qr{(?:[^\x30-\x39\x41-\x46\x61-\x66])};
${Char::Elatin9::eb}          = qr{(?:\A(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[0-9A-Z_a-z])|(?<=[0-9A-Z_a-z])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]|\z))};
${Char::Elatin9::eB}          = qr{(?:(?<=[0-9A-Z_a-z])(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]))};

# avoid: Name "Char::Elatin9::foo" used only once: possible typo at here.
${Char::Elatin9::dot}         = ${Char::Elatin9::dot};
${Char::Elatin9::dot_s}       = ${Char::Elatin9::dot_s};
${Char::Elatin9::eD}          = ${Char::Elatin9::eD};
${Char::Elatin9::eS}          = ${Char::Elatin9::eS};
${Char::Elatin9::eW}          = ${Char::Elatin9::eW};
${Char::Elatin9::eH}          = ${Char::Elatin9::eH};
${Char::Elatin9::eV}          = ${Char::Elatin9::eV};
${Char::Elatin9::eR}          = ${Char::Elatin9::eR};
${Char::Elatin9::eN}          = ${Char::Elatin9::eN};
${Char::Elatin9::not_alnum}   = ${Char::Elatin9::not_alnum};
${Char::Elatin9::not_alpha}   = ${Char::Elatin9::not_alpha};
${Char::Elatin9::not_ascii}   = ${Char::Elatin9::not_ascii};
${Char::Elatin9::not_blank}   = ${Char::Elatin9::not_blank};
${Char::Elatin9::not_cntrl}   = ${Char::Elatin9::not_cntrl};
${Char::Elatin9::not_digit}   = ${Char::Elatin9::not_digit};
${Char::Elatin9::not_graph}   = ${Char::Elatin9::not_graph};
${Char::Elatin9::not_lower}   = ${Char::Elatin9::not_lower};
${Char::Elatin9::not_lower_i} = ${Char::Elatin9::not_lower_i};
${Char::Elatin9::not_print}   = ${Char::Elatin9::not_print};
${Char::Elatin9::not_punct}   = ${Char::Elatin9::not_punct};
${Char::Elatin9::not_space}   = ${Char::Elatin9::not_space};
${Char::Elatin9::not_upper}   = ${Char::Elatin9::not_upper};
${Char::Elatin9::not_upper_i} = ${Char::Elatin9::not_upper_i};
${Char::Elatin9::not_word}    = ${Char::Elatin9::not_word};
${Char::Elatin9::not_xdigit}  = ${Char::Elatin9::not_xdigit};
${Char::Elatin9::eb}          = ${Char::Elatin9::eb};
${Char::Elatin9::eB}          = ${Char::Elatin9::eB};
...
sub Char::Elatin9::lcfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Char::Elatin9::lc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Char::Elatin9::lc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Char::Elatin9::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}
...
sub Char::Elatin9::ucfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Char::Elatin9::uc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Char::Elatin9::uc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Char::Elatin9::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}
    ...
    for my $string (@string) {
        ...
        for (my $i=0; $i <= $#char; $i++) {
            ...
            # with /i modifier
                ...
                my $uc = Char::Elatin9::uc($char[$i]);
                my $fc = Char::Elatin9::fc($char[$i]);
                if ($uc ne $fc) {
                    if (CORE::length($fc) == 1) {
                        $char[$i] = '['   . $uc       . $fc . ']';
                    }
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # POSIX-style character classes
            ...
            $char[$i] = {
                ...
                '[:^lower:]'  => '${Char::Elatin9::not_lower_i}',
                '[:^upper:]'  => '${Char::Elatin9::not_upper_i}',
            ...
            $char[$i] = {
                ...
                '[:^alnum:]'  => '${Char::Elatin9::not_alnum}',
                '[:^alpha:]'  => '${Char::Elatin9::not_alpha}',
                '[:^ascii:]'  => '${Char::Elatin9::not_ascii}',
                '[:^blank:]'  => '${Char::Elatin9::not_blank}',
                '[:^cntrl:]'  => '${Char::Elatin9::not_cntrl}',
                '[:^digit:]'  => '${Char::Elatin9::not_digit}',
                '[:^graph:]'  => '${Char::Elatin9::not_graph}',
                '[:^lower:]'  => '${Char::Elatin9::not_lower}',
                '[:^print:]'  => '${Char::Elatin9::not_print}',
                '[:^punct:]'  => '${Char::Elatin9::not_punct}',
                '[:^space:]'  => '${Char::Elatin9::not_space}',
                '[:^upper:]'  => '${Char::Elatin9::not_upper}',
                '[:^word:]'   => '${Char::Elatin9::not_word}',
                '[:^xdigit:]' => '${Char::Elatin9::not_xdigit}',
            ...
            for (@singleoctet) {
                while (s/ \A \\x(..) - \\x(..) //oxms or s/ \A \\x((..)) //oxms) {
                    for my $ord (hex($1) .. hex($2)) {
                        ...
                        my $uc = Char::Elatin9::uc($char);
                        my $fc = Char::Elatin9::fc($char);
                        if ($uc eq $fc) {
...
#               $pattern .= "(?:$your_char)",   # UNIX style
            ...
            elsif ((my $fc = Char::Elatin9::fc($char)) ne $char) {
                $pattern .= $fc;
            }
            else {
        ...
        my $matchsub = sub { Char::Elatin9::fc($_[0]) =~ /\A $pattern \z/xms };
...
INNER:
        for my $leaf (@leaf) {
            ...
            if (Char::Elatin9::index($leaf,'.') == -1 and   # if name does not have a dot in it *and*
                CORE::length($leaf) <= 8 and        # name is shorter than or equal to 8 chars *and*
                Char::Elatin9::index($pattern,'\\.') != -1  # pattern has a dot.
            ) {
                if (&$matchsub("$leaf.")) {
                    push @matched, "$head$leaf";
                    next INNER;
...
sub Char::Latin9::getc(;*@) {
    ...
    croak 'Too many arguments for Char::Latin9::getc' if @_ and not wantarray;
    ...
    for my $length ($length[0] .. $length[-1]) {
        ...
        if (exists $range_tr{CORE::length($getc)}) {
            if ($getc =~ /\A ${Char::Elatin9::dot_s} \z/oxms) {
...
sub Char::Latin9::index($$;$) {
    ...
    my $index;
    if (@_ == 3) {
        $index = Char::Elatin9::index($_[0], $_[1], CORE::length(Char::Latin9::substr($_[0], 0, $_[2])));
    }
    else {
        $index = Char::Elatin9::index($_[0], $_[1]);
    }
    ...
    if ($index == -1) {
        ...
        return Char::Latin9::length(CORE::substr $_[0], 0, $index);
    }
}
...
sub Char::Latin9::rindex($$;$) {
    ...
    my $rindex;
    if (@_ == 3) {
        $rindex = Char::Elatin9::rindex($_[0], $_[1], CORE::length(Char::Latin9::substr($_[0], 0, $_[2])));
    }
    else {
        $rindex = Char::Elatin9::rindex($_[0], $_[1]);
    }
    ...
    if ($rindex == -1) {
        ...
        return Char::Latin9::length(CORE::substr $_[0], 0, $rindex);
    }
}
...
my $qq_substr  = qr{(?: Char::Latin9::substr | CORE::substr | substr ) \( $qq_paren \)
                 }xms;
...
sub Char::Latin9::escape(;$) {
    ...
    while (not /\G \z/oxgc) { # member
        $e_script .= Char::Latin9::escape_token();
    }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Char::Elatin9::PREMATCH()
    elsif (/\G ( \$` | \$\{`\} | \$ \s* PREMATCH  \b | \$ \s* \{ \s* PREMATCH  \s* \} | \$ \s* \{\^PREMATCH\}  ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Elatin9::PREMATCH()};
    }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Char::Elatin9::MATCH()
    elsif (/\G ( \$& | \$\{&\} | \$ \s* MATCH     \b | \$ \s* \{ \s* MATCH     \s* \} | \$ \s* \{\^MATCH\}     ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Elatin9::MATCH()};
    }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Char::Elatin9::POSTMATCH()
    elsif (/\G (                 \$ \s* POSTMATCH \b | \$ \s* \{ \s* POSTMATCH \s* \} | \$ \s* \{\^POSTMATCH\} ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Elatin9::POSTMATCH()};
    }
...
# while (<WILDCARD>) --- glob
    ...
    # avoid "Error: Runtime exception" of perl version 5.005_03
        ...
        return 'while ($_ = Char::Elatin9::glob("' . $1 . '"))';
    }

# while (glob)
    elsif (/\G \b while \s* \( \s* glob \s* \) /oxgc) {
        return 'while ($_ = Char::Elatin9::glob_)';
    }

# while (glob(WILDCARD))
    elsif (/\G \b while \s* \( \s* glob \b /oxgc) {
        return 'while ($_ = Char::Elatin9::glob';
    }
...
# subroutines of package Char::Elatin9
    elsif (/\G \b (CORE:: | ->[ ]* (?: atan2 | [a-z]{2,})) \b  /oxgc) { $slash = 'm//'; return $1;                  }
    elsif (/\G \b Char::Latin9::eval       (?= \s* \{ )                /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::Latin9::eval    \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'eval Char::Latin9::escape'; }
    elsif (/\G \b bytes::substr \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'substr';            }
    elsif (/\G \b chop \b          (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Elatin9::chop';       }
    elsif (/\G \b bytes::index \b  (?! \s* => )                /oxgc) { $slash = 'm//'; return 'index';             }
    elsif (/\G \b Char::Latin9::index \b   (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Latin9::index';       }
    elsif (/\G \b index \b         (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Elatin9::index';      }
    elsif (/\G \b bytes::rindex \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'rindex';            }
    elsif (/\G \b Char::Latin9::rindex \b  (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Latin9::rindex';      }
    elsif (/\G \b rindex \b        (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Elatin9::rindex';     }
    elsif (/\G \b lc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin9::lc';         }
    elsif (/\G \b lcfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin9::lcfirst';    }
    elsif (/\G \b uc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin9::uc';         }
    elsif (/\G \b ucfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin9::ucfirst';    }
    elsif (/\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin9::fc';         }
    ...
    elsif (/\G \b chr           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin9::chr';               }
    elsif (/\G \b bytes::ord    (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return $function_ord;              }
    elsif (/\G \b glob          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin9::glob';              }
    elsif (/\G \b lc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin9::lc_';               }
    elsif (/\G \b lcfirst \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin9::lcfirst_';          }
    elsif (/\G \b uc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin9::uc_';               }
    elsif (/\G \b ucfirst \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin9::ucfirst_';          }
    elsif (/\G \b fc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin9::fc_';               }
    ...
    elsif (/\G \b chr \b           (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin9::chr_';              }
    elsif (/\G \b bytes::ord \b    (?! \s* => )                      /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord \b           (?! \s* => )                      /oxgc) { $slash = 'div'; return $function_ord_;             }
    elsif (/\G \b glob \b          (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin9::glob_';             }
...
# end of split
        if    (/\G (?= [,;\)\}\]] )          /oxgc) { return 'Char::Elatin9::split' . $e;                 }

# split scalar value
        elsif (/\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { return 'Char::Elatin9::split' . $e . e_string($1);  }

# split literal space
        elsif (/\G \b qq       (\#) [ ] (\#) /oxgc) { return 'Char::Elatin9::split' . $e . qq  {qq$1 $2}; }
        elsif (/\G \b qq (\s*) (\() [ ] (\)) /oxgc) { return 'Char::Elatin9::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\{) [ ] (\}) /oxgc) { return 'Char::Elatin9::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\[) [ ] (\]) /oxgc) { return 'Char::Elatin9::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\<) [ ] (\>) /oxgc) { return 'Char::Elatin9::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\S) [ ] (\2) /oxgc) { return 'Char::Elatin9::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b q        (\#) [ ] (\#) /oxgc) { return 'Char::Elatin9::split' . $e . qq   {q$1 $2}; }
        elsif (/\G \b q  (\s*) (\() [ ] (\)) /oxgc) { return 'Char::Elatin9::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\{) [ ] (\}) /oxgc) { return 'Char::Elatin9::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\[) [ ] (\]) /oxgc) { return 'Char::Elatin9::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\<) [ ] (\>) /oxgc) { return 'Char::Elatin9::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\S) [ ] (\2) /oxgc) { return 'Char::Elatin9::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G                ' [ ] '    /oxgc) { return 'Char::Elatin9::split' . $e . qq     {' '};  }
        elsif (/\G                " [ ] "    /oxgc) { return 'Char::Elatin9::split' . $e . qq     {" "};  }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> @{[Char::Elatin9::PREMATCH()]}
            ...
            $e_string .= q{Char::Elatin9::PREMATCH()};
            $slash = 'div';
        }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> @{[Char::Elatin9::MATCH()]}
        elsif ($string =~ /\G ( \$& | \$\{&\} | \$ \s* MATCH     \b | \$ \s* \{ \s* MATCH     \s* \} | \$ \s* \{\^MATCH\}     ) /oxmsgc) {
            $e_string .= q{Char::Elatin9::MATCH()};
            $slash = 'div';
        }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> @{[Char::Elatin9::POSTMATCH()]}
            ...
            $e_string .= q{Char::Elatin9::POSTMATCH()};
            $slash = 'div';
        }
...
# subroutines of package Char::Elatin9
        ...
        elsif ($string =~ /\G \b Char::Latin9::eval       (?= \s* \{ )                /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Latin9::eval \b                                /oxgc) { $e_string .= 'eval Char::Latin9::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::substr \b                             /oxgc) { $e_string .= 'substr';            $slash = 'm//'; }
        elsif ($string =~ /\G \b chop \b                                      /oxgc) { $e_string .= 'Char::Elatin9::chop';       $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::index \b                              /oxgc) { $e_string .= 'index';             $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Latin9::index \b                               /oxgc) { $e_string .= 'Char::Latin9::index';       $slash = 'm//'; }
        elsif ($string =~ /\G \b index \b                                     /oxgc) { $e_string .= 'Char::Elatin9::index';      $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::rindex \b                             /oxgc) { $e_string .= 'rindex';            $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Latin9::rindex \b                              /oxgc) { $e_string .= 'Char::Latin9::rindex';      $slash = 'm//'; }
        elsif ($string =~ /\G \b rindex \b                                    /oxgc) { $e_string .= 'Char::Elatin9::rindex';     $slash = 'm//'; }
        elsif ($string =~ /\G \b lc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin9::lc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin9::lcfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b uc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin9::uc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin9::ucfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin9::fc';         $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin9::chr';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b glob          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin9::glob';              $slash = 'm//'; }
        elsif ($string =~ /\G \b lc \b                                              /oxgc) { $e_string .= 'Char::Elatin9::lc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst \b                                         /oxgc) { $e_string .= 'Char::Elatin9::lcfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b uc \b                                              /oxgc) { $e_string .= 'Char::Elatin9::uc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst \b                                         /oxgc) { $e_string .= 'Char::Elatin9::ucfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b fc \b                                              /oxgc) { $e_string .= 'Char::Elatin9::fc_';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr \b                                             /oxgc) { $e_string .= 'Char::Elatin9::chr_';              $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::ord \b                                      /oxgc) { $e_string .= 'ord';                      $slash = 'div'; }
        elsif ($string =~ /\G \b ord \b                                             /oxgc) { $e_string .= $function_ord_;             $slash = 'div'; }
        elsif ($string =~ /\G \b glob \b                                            /oxgc) { $e_string .= 'Char::Elatin9::glob_';             $slash = 'm//'; }
...
# end of split
            if    ($string =~ /\G (?= [,;\)\}\]] )          /oxgc) { return 'Char::Elatin9::split' . $e;                                           }

# split scalar value
            elsif ($string =~ /\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { $e_string .= 'Char::Elatin9::split' . $e . e_string($1);  next E_STRING_LOOP; }

# split literal space
            elsif ($string =~ /\G \b qq       (\#) [ ] (\#) /oxgc) { $e_string .= 'Char::Elatin9::split' . $e . qq  {qq$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\() [ ] (\)) /oxgc) { $e_string .= 'Char::Elatin9::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\{) [ ] (\}) /oxgc) { $e_string .= 'Char::Elatin9::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\[) [ ] (\]) /oxgc) { $e_string .= 'Char::Elatin9::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\<) [ ] (\>) /oxgc) { $e_string .= 'Char::Elatin9::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\S) [ ] (\2) /oxgc) { $e_string .= 'Char::Elatin9::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q        (\#) [ ] (\#) /oxgc) { $e_string .= 'Char::Elatin9::split' . $e . qq   {q$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\() [ ] (\)) /oxgc) { $e_string .= 'Char::Elatin9::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\{) [ ] (\}) /oxgc) { $e_string .= 'Char::Elatin9::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\[) [ ] (\]) /oxgc) { $e_string .= 'Char::Elatin9::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\<) [ ] (\>) /oxgc) { $e_string .= 'Char::Elatin9::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\S) [ ] (\2) /oxgc) { $e_string .= 'Char::Elatin9::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G                ' [ ] '    /oxgc) { $e_string .= 'Char::Elatin9::split' . $e . qq     {' '};  next E_STRING_LOOP; }
            elsif ($string =~ /\G                " [ ] "    /oxgc) { $e_string .= 'Char::Elatin9::split' . $e . qq     {" "};  next E_STRING_LOOP; }
...
sub character_class {
    ...
    if ($char eq '.') {
        if ($modifier =~ /s/) {
            return '${Char::Elatin9::dot_s}';
        }
        else {
            return '${Char::Elatin9::dot}';
        }
    }
    else {
        return Char::Elatin9::classic_character_class($char);
    }
}
...
sub e_tr {
    ...
    if ($modifier =~ tr/bB//d) {
        ...
        if ($variable eq '') {
            $e_tr = qq{Char::Elatin9::tr(\$_,' =~ ',$charclass,$e$charclass2,'$modifier')};
        }
        else {
            $e_tr = qq{Char::Elatin9::tr($variable,'$bind_operator',$charclass,$e$charclass2,'$modifier')};
        }
    }
...
sub e_qq {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # octal escape sequence
            ...
            $char[$i] = Char::Elatin9::octchr($1);
        }

        # hexadecimal escape sequence
        elsif ($char[$i] =~ /\A \\x \{ ([0-9A-Fa-f]+) \} \z/oxms) {
            $char[$i] = Char::Elatin9::hexchr($1);
        }
        ...
        # \u \l \U \L \F \Q \E
            ...
            $char[$i] = '@{[Char::Elatin9::ucfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\l') {
            $char[$i] = '@{[Char::Elatin9::lcfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\U') {
            $char[$i] = '@{[Char::Elatin9::uc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\L') {
            $char[$i] = '@{[Char::Elatin9::lc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\F') {
            $char[$i] = '@{[Char::Elatin9::fc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\Q') {
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Char::Elatin9::charlist_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Char::Elatin9::charlist_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # open character class [^...]
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    # [^...]
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Char::Elatin9::charlist_not_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Char::Elatin9::charlist_not_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ /\A [\x00-\xFF] \z/oxms) and (Char::Elatin9::uc($char[$i]) ne Char::Elatin9::fc($char[$i]))) {
            if (CORE::length(Char::Elatin9::fc($char[$i])) == 1) {
                $char[$i] = '['   . Char::Elatin9::uc($char[$i])       . Char::Elatin9::fc($char[$i]) . ']';
            }
            else {
                $char[$i] = '(?:' . Char::Elatin9::uc($char[$i]) . '|' . Char::Elatin9::fc($char[$i]) . ')';
            }
        ...
        # $0 --> $0
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Elatin9::ignorecase(' . $char[$i] . ')]}';
            }
        }
        elsif ($char[$i] =~ /\A \$ \{ \s* 0 \s* \} \z/oxms) {
            if ($ignorecase) {
        ...
        # $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Char::Elatin9::PREMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Elatin9::ignorecase(Char::Elatin9::PREMATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Elatin9::PREMATCH()]}';
            }
        ...
        # $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Char::Elatin9::MATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Elatin9::ignorecase(Char::Elatin9::MATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Elatin9::MATCH()]}';
            }
        ...
        # $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Char::Elatin9::POSTMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Elatin9::ignorecase(Char::Elatin9::POSTMATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Elatin9::POSTMATCH()]}';
            }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                        2   3                                 4   5
                q<CORE::eval{local $Char::Latin9::re_t=%s; while($Char::Latin9::re_t =~ %s){%s local $^W=0; local $Char::Latin9::re_r=%s; %s$Char::Latin9::re_t="$`$Char::Latin9::re_r$'"; pos($Char::Latin9::re_t)=length "$`$Char::Latin9::re_r"; } return $Char::Latin9::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Char::Latin9::re_r=CORE::eval $Char::Latin9::re_r; ' x $e_modifier,            #  5
            );
        }
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                 4   5  6                    7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Char::Latin9::re_r=%s; %s"%s$Char::Latin9::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                       1     2   3                                 4   5 6                         7                                                 8
                q<CORE::eval{local $Char::Latin9::re_n=0; while(%s =~ %s){%s local $^W=0; local $Char::Latin9::re_r=%s; %s%s="$`$Char::Latin9::re_r$'"; pos(%s)=length "$`$Char::Latin9::re_r"; $Char::Latin9::re_n++} return %s$Char::Latin9::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                 5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Char::Latin9::re_r=%s; %s%s="%s$Char::Latin9::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                 5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Char::Latin9::re_r=%s; %s%s="%s$Char::Latin9::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Char::Latin9::re_r=CORE::eval $Char::Latin9::re_r; ' x $e_modifier,            #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
sub e_split {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # ${ foo }
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Elatin9::ignorecase(' . $1 . ')]}';
            }
        }
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        return join '', 'Char::Elatin9::split', $ope, $delimiter, @char, '>]}' x ($left_e - $right_e), $end_delimiter, $modifier;
    }
    return     join '', 'Char::Elatin9::split', $ope, $delimiter, @char,                               $end_delimiter, $modifier;
}
...
=head1 SYNOPSIS
  ...
  use Char::Elatin9;
    ...
    Char::Elatin9::lc(...);
    Char::Elatin9::lc_;
    Char::Elatin9::lcfirst(...);
    Char::Elatin9::lcfirst_;
    Char::Elatin9::uc(...);
    Char::Elatin9::uc_;
    Char::Elatin9::ucfirst(...);
    Char::Elatin9::ucfirst_;
    Char::Elatin9::fc(...);
    Char::Elatin9::fc_;
    Char::Elatin9::ignorecase(...);
    Char::Elatin9::capture(...);
    Char::Elatin9::chr(...);
    Char::Elatin9::chr_;
    Char::Elatin9::glob(...);
    Char::Elatin9::glob_;

  # "no Char::Elatin9;" not supported

=head1 ABSTRACT

This module has run-time routines for use Char::Latin9 software automatically, you
do not have to use.
...
some bugs. Thus, if you happen to find a bug that's in Char::Latin9 software and not
...
This Char::Elatin9 module first appeared in ActivePerl Build 522 Built under
...
=item Split string
  ...
  @split = Char::Elatin9::split(/pattern/,$string,$limit);
  @split = Char::Elatin9::split(/pattern/,$string);
  @split = Char::Elatin9::split(/pattern/);
  @split = Char::Elatin9::split('',$string,$limit);
  @split = Char::Elatin9::split('',$string);
  @split = Char::Elatin9::split('');
  @split = Char::Elatin9::split();
  @split = Char::Elatin9::split;
  ...
  at all, Char::Elatin9::split returns the original string as a single substring, If it
  ...
  @chars  = Char::Elatin9::split(//,  $word);
  @fields = Char::Elatin9::split(/:/, $line);
  @words  = Char::Elatin9::split(" ", $paragraph);
  @lines  = Char::Elatin9::split(/^/, $buffer);
  ...
  print join(":" => Char::Elatin9::split(/ */, "hi there"));
  ...
  Char::Elatin9::split's pattern is exempt from that wrinkle.)

  The $limit parameter splits only part of a string:

  my ($login, $passwd, $remainder) = Char::Elatin9::split(/:/, $_, 3);
  ...
  splits on whitespace just as Char::Elatin9::split with no arguments does. Thus,
  Char::Elatin9::split(" ") can be used to emulate awk's default behavior. In contrast,
  Char::Elatin9::split(/ /) will give you as many null initial fields as there are
  ...
  $string = join(" ", Char::Elatin9::split(" ", $string));
  ...
  %head = ("FRONTSTUFF", Char::Elatin9::split(/^(\S*?):\s*/m, $header));
  ...
  while (<>) {
      for my $word (Char::Elatin9::split()) {
          $count{$word}++;
      }
  }

  The inverse of Char::Elatin9::split is join, except that join can only join with the
...
=item Transliteration
  ...
  $tr = Char::Elatin9::tr($variable,$bind_operator,$searchlist,$replacementlist,$modifier);
  $tr = Char::Elatin9::tr($variable,$bind_operator,$searchlist,$replacementlist);
  ...
  print Char::Elatin9::tr('bookkeeper','=~','boep','peob','r'); # prints 'peekkoobor'

=item Chop string

  $chop = Char::Elatin9::chop(@list);
  $chop = Char::Elatin9::chop();
  $chop = Char::Elatin9::chop;

  This subroutine chops off the last character of a string variable and returns the
  character chopped. The Char::Elatin9::chop subroutine is used primary to remove the newline
  ...
  since Char::Elatin9::chop always shortens the string no matter what's there, and chomp
  is more selective. If no argument is given, the subroutine chops the $_ variable.

  You cannot Char::Elatin9::chop a literal, only a variable. If you Char::Elatin9::chop a list of
  variables, each string in the list is chopped:

  @lines = `cat myfile`;
  Char::Elatin9::chop(@lines);

  You can Char::Elatin9::chop anything that is an lvalue, including an assignment:

  Char::Elatin9::chop($cwd = `pwd`);
  Char::Elatin9::chop($answer = <STDIN>);

  This is different from:

  $answer = Char::Elatin9::chop($tmp = <STDIN>); # WRONG

  which puts a newline into $answer because Char::Elatin9::chop returns the character
  ...
  In the most general case, Char::Elatin9::chop can be expressed using substr:

  $last_code = Char::Elatin9::chop($var);
  $last_code = substr($var, -1, 1, ""); # same thing

  Once you understand this equivalence, you can use it to do bigger chops. To
  Char::Elatin9::chop more than one character, use substr as an lvalue, assigning a null
  ...
  form of substr, creating something of a quintuple Char::Elatin9::chop;
...
=item Index string
  ...
  $byte_pos = Char::Elatin9::index($string,$substr,$byte_offset);
  $byte_pos = Char::Elatin9::index($string,$substr);
  ...
  $byte_pos = -1;
  while (($byte_pos = Char::Elatin9::index($string, $lookfor, $byte_pos)) > -1) {
...
=item Reverse index string
  ...
  $byte_pos = Char::Elatin9::rindex($string,$substr,$byte_offset);
  $byte_pos = Char::Elatin9::rindex($string,$substr);

  This subroutine works just like Char::Elatin9::index except that it returns the byte
  position of the last occurrence of $substring in $string (a reverse Char::Elatin9::index).
  ...
  while (($byte_pos = Char::Latin9::rindex($string, $lookfor, $byte_pos)) >= 0) {
      print "Found at $byte_pos\n";
      $byte_pos--;
  }
...
=item Lower case string
  ...
  You can use the Char::Elatin9::fc subroutine for case-insensitive comparisons via Char::Latin9
  software.

=item Lower case first character of string

  $lcfirst = Char::Elatin9::lcfirst($string);
  $lcfirst = Char::Elatin9::lcfirst_;
...
=item Upper case string
  ...
  in interpolated strings. For titlecase, use Char::Elatin9::ucfirst instead.
...
=item Upper case first character of string
  ...
  $ucfirst = Char::Elatin9::ucfirst($string);
  $ucfirst = Char::Elatin9::ucfirst_;
  ...
  $titlecase = Char::Elatin9::ucfirst(substr($word,0,1)) . Char::Elatin9::lc(substr($word,1));
  ...
  $do_not_use = Char::Elatin9::ucfirst(Char::Elatin9::lc($word));
...
=item Fold case string
  ...
  $fc = Char::Elatin9::fc($string);
  $fc = Char::Elatin9::fc_;

  New to Char::Latin9 software, this subroutine returns the full Unicode-like casefold of
  ...
  Char::Elatin9::fc($a) eq Char::Elatin9::fc($b)

  The reliable way to compare string case-insensitively was with the /i pattern
  modifier, because Char::Latin9 software has always used casefolding semantics for
...
=item Make ignore case string
  ...
  @ignorecase = Char::Elatin9::ignorecase(@string);

  This subroutine is internal use to m/ /i, s/ / /i, split / /i, and qr/ /i.

=item Make capture number

  $capturenumber = Char::Elatin9::capture($string);

  This subroutine is internal use to m/ /, s/ / /, split / /, and qr/ /.

=item Make character

  $chr = Char::Elatin9::chr($code);
  $chr = Char::Elatin9::chr_;

  This subroutine returns a programmer-visible character, character represented by
  that $code in the character set. For example, Char::Elatin9::chr(65) is "A" in either
  ASCII or Latin-9, not Unicode. For the reverse of Char::Elatin9::chr, use Char::Latin9::ord.

=item Filename expansion (globbing)

  @glob = Char::Elatin9::glob($string);
  @glob = Char::Elatin9::glob_;
  ...
  The Char::Elatin9::glob subroutine grandfathers the use of whitespace to separate multiple
  ...
  @spacies = <"*e f*">;
  @spacies = Char::Elatin9::glob('"*e f*"');
  @spacies = Char::Elatin9::glob(q("*e f*"));

  If you had to get a variable through, you could do this:

  @spacies = Char::Elatin9::glob("'*${var}e f*'");
  @spacies = Char::Elatin9::glob(qq("*${var}e f*"));
