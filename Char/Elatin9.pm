...
BEGIN {
    ...
    sub Char::Elatin9::binmode(*;$);
    sub Char::Elatin9::open(*;$@);
    ...
    if ($] < 5.006) {
        ...
        if ($^O ne 'MacOS') {
            *CORE::GLOBAL::binmode =
            *CORE::GLOBAL::binmode = \&Char::Elatin9::binmode;
        }
        *CORE::GLOBAL::open    =
        *CORE::GLOBAL::open    = \&Char::Elatin9::open;
    }
}
...
=item Make character
  ...
  set. For example, Char::Elatin9::chr(65) is "A" in either ASCII or Latin-9, and
  Char::Elatin9::chr(0x82a0) is a Latin-9 HIRAGANA LETTER A. For the reverse of Char::Elatin9::chr,
  use Char::Latin9::ord.
...
=item binary mode (Perl5.6 emulation on perl5.005)
  ...
  Char::Elatin9::binmode(FILEHANDLE, $disciplines);
  Char::Elatin9::binmode(FILEHANDLE);
  Char::Elatin9::binmode($filehandle, $disciplines);
  Char::Elatin9::binmode($filehandle);
...
=item open file (Perl5.6 emulation on perl5.005)
  ...
  $rc = Char::Elatin9::open(FILEHANDLE, $mode, $expr);
  $rc = Char::Elatin9::open(FILEHANDLE, $expr);
  $rc = Char::Elatin9::open(FILEHANDLE);
  $rc = Char::Elatin9::open(my $filehandle, $mode, $expr);
  $rc = Char::Elatin9::open(my $filehandle, $expr);
  $rc = Char::Elatin9::open(my $filehandle);
  ...
  * three arguments
  ...
  {
      my $fh;                          # (uninitialized)
      Char::Elatin9::open($fh, ">logfile")     # $fh is autovivified
  ...
  Char::Elatin9::open my $fh, ">logfile" or die ...
  ...
  Char::Elatin9::open(LOG, ">", "logfile") or die "Can't create logfile: $!";
  ...
  $path =~ s#^([ ])#./$1#;
  Char::Elatin9::open (FH, "< $path\0") or die "can't open $path: $!";
  ...
  Char::Elatin9::open(FH, "<", $path) or die "can't open $path: $!";
  ...
  Char::Elatin9::open(FH, "<:raw", $path) or die "can't open $path: $!";
  ...
  Char::Elatin9::open(FH, "<:crlf:encoding(Char::Latin9)", $path) or die "can't open $path: $!";
