...
######################################################################
#
# Char::Latin9 - Source code filter to Latin-9 script
#
...
sub Char::Latin9::escape_script {
    ...
    if (/^ use Char::Elatin9(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        $e_script .= sprintf("use Char::Elatin9 %s;\n%s", $Char::Elatin9::VERSION, $use_re_eval); # require run-time routines version
...
Char::Latin9 - Source code filter to escape Latin-9

=head1 SYNOPSIS

  use Char::Latin9;
  use Char::Latin9 version;         --- require version
