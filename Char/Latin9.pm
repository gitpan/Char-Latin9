...
# split
            ...
            my $e_string = 'Char::Elatin9::split';
...
and the cellular phone. This software treats Latin-9 directly. Therefor there is
not UTF8 flag.
...
=item * Possible to handle raw Latin-9 values

=item * Backward compatibility of data, script and how to

=item * Only Char/Latin9.pm and Char/Elatin9.pm, other modules are unnecessary
...
functions.
  ...
  ---------------------------------
  lc          Char::Elatin9::lc
  lcfirst     Char::Elatin9::lcfirst
  uc          Char::Elatin9::uc
  ucfirst     Char::Elatin9::ucfirst
  chr         Char::Elatin9::chr
  glob        Char::Elatin9::glob
  ---------------------------------
...
Char/Latin9.pm remove 'bytes::' at head of function name.
...
=head1 Perl5.6 Emulation On perl5.005
  ...
  --------------------------------------------------------------------
  Before          After                  in BEGIN { } of Char/Elatin9.pm
  --------------------------------------------------------------------
  binmode(...);   Char::Elatin9::binmode(...);   *CORE::GLOBAL::binmode = ...
  open(...);      Char::Elatin9::open(...);      *CORE::GLOBAL::open    = ...
  --------------------------------------------------------------------
...
=item * binmode (Perl5.6 emulation on perl5.005)
  ...
  * two arguments
  ...
  If you are using perl5.005 other than MacPerl, Char::Latin9 software emulate perl5.6's
...
=item * open (Perl5.6 emulation on perl5.005)
  ...
  * three arguments
  ...
  If you are using perl5.005, Char::Latin9 software emulate perl5.6's open function.
  ...
  open(FH, "<:crlf:encoding(Char::Latin9)", $path) or die "can't open $path: $!";
...
page 402 of Programming Perl, 3rd ed. again.
  ...
  Information processing model beginning with this software
    ...
    +-----------------------------------+
    |      ASCII Compatible Encoding    | ex. Latin-9
    +-----------------------------------+
                (No UTF8 Flag)
