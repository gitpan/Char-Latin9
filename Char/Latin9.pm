...
END
            ...
            if ($list !~ /\A \s* \z/oxms) {
                ...
                for (@list) {
                    $Char::Elatin9::function_ord     = 'Char::Latin9::ord'     if /\A ord \z/oxms;
                    $Char::Elatin9::function_ord_    = 'Char::Latin9::ord_'    if /\A ord \z/oxms;
                    $Char::Elatin9::function_reverse = 'Char::Latin9::reverse' if /\A reverse \z/oxms;
                    $Char::Elatin9::function_getc    = 'Char::Latin9::getc'    if /\A getc \z/oxms;
                }
            }
        }
    }

    $e_script .= Char::Latin9::escape();
...
=head1 Calling 'Char::Elatin9::ignorecase()' (Char::Latin9 software provides)

Char::Latin9 software applies calling 'Char::Elatin9::ignorecase()' instead of /i modifier.
...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Char::Latin9 software provides)

Char::Latin9 software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Char::Latin9 software provide)
...
=head1 Un-Escaping bytes::* Subroutines (Char::Latin9 software provides)

Char::Latin9 software removes 'bytes::' at head of subroutine name.
...
some bugs. Thus, if you happen to find a bug that's in Char::Latin9 software and
